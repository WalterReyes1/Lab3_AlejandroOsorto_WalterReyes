        ...
        while (opcion != 4) {
            ...
            switch (opcion) {
                ...
                case 3: {
                    ...
                    //--------------------------------
                    // es 1234 la contraseña;
                    System.out.print("Ingrese la contraseña: ");
                    String contraseña = lectura.next();

                    //Aqui valido la contraseña
                    //-------------------------
                    if (contraseña.equals("1234") && usuarioSUDO.equals("SUDO")) {
                        int subOpcion = 1;
                                    ...
                                    switch (subSubOpcion) {
                                        case 1: {
                                            ...
                                            while (fin == false) {
                                                ...
                                                contraseñas.add(contraseñaEmpleado);
                                                ...
                                                System.out.print("Ingrese artículos vendidos: ");
                                                int vend = lectura.nextInt();
                                                Personas p = new Personas(id, usuario, contraseña, correo, nombreEmpleado);
                                                Empleados e = new Empleados(hora, vend);
                                            ...
                                            while (valo == 0) {
                                                ...
                                                if (tipo == 1) //Ropa
                                                {
                                                    ...
                                                    producto.add(new Ropa(sexo, talla, desc, nombre1, precio));
                                                } else if (tipo == 2) //Juguete
                                                {
                                                    System.out.print("Ingrese la descripcion del juguete: ");
                                                    lectura.nextLine();
                                                    String descJug = lectura.nextLine();
                                                    producto.add(new Juguetes(descJug, desc, nombre1, precio));
                                                } else if (tipo == 3) //Comida
                                                {
                                                    ...
                                                    producto.add(new Comida(tipoComida, fecha, desc, nombre1, precio));
                                                }
                                                System.out.println("Desea ingresar otro producto? 1- si, 2 no: ");
                                                valo = lectura.nextInt();

                                            } // fin while 

                                            Locales.add(new Locales(nombre, empleados, producto, nombreG));
